...
class _ProjectDocPanelState extends State<ProjectDocPanel> {
  ...
  List<Widget> _buildContentWidgets() {
    ...
    for (String line in lines) {
      ...
      // Skip store link lines since we're showing them as buttons
            ...
            child: ClipRRect(
              ...
              child: Stack(
                children: [
                  ...
                  // Add a subtle border for PNG images
                  Positioned.fill(
                    child: Container(
                      decoration: BoxDecoration(
  ...
  Widget _buildTextLine(String text) {
    ...
    // Handle special highlights (like 🔄, 🚀, etc.)
    if (text.startsWith('🔄') || 
        text.startsWith('🚀') || 
        text.startsWith('🌐') || 
        text.startsWith('🔒') || 
